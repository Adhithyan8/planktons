"""
We try prior matching with a power law distribution but without labels
...
for dataset in datasets:
    ...
    # save the model
    torch.save(model.state_dict(), f"outputs/exp_07_{dataset}.pt")
