"""
Lets pretend to start from the beginning.

For the datasets, we have lets just use a pretrained model to get the embeddings.
And we will later evaluate the embeddings using kNN and K-means clustering.
"""
...
# should be enough for these first evaluations
torch.set_float32_matmul_precision("medium")

model = torch.hub.load("facebookresearch/dino:main", "dino_vitb16")  # TODO: try dinov2
